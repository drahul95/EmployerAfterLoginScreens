...
function ApplicationSavedBoxListActivate() {
  ...
  return (
    ...
    >
      ...
      <Box component="div" className="dis_flex">
        ...
        <Box component="div" className="marginautoright">
          <Button className="grnbtnactivate" onClick={handleOpenactivatemodal}>
            Activate
          </Button>
        </Box>
      </Box>
        ...
        <Fade in={openactivatemodal}>
          <div className="modalcontsmall">
            ...
            <Typography variant="h6">
              Are you sure you want to Activate the job posting ?
            </Typography>
...
export default ApplicationSavedBoxListActivate;
const YearsIcon = () => {
  return (
    <svg
