...
function ApplicationSavedBoxListSuspend() {
    ...
    >
      ...
      <Box component="div" className="dis_flex">
        ...
        <Box component="div" className="marginautoright">
          <Button component="div" className="suspendbtn dis_flex">
            <Box component="div" className="statusbox">
              <Typography variant="span">Suspend</Typography>
            </Box>
          </Button>
        </Box>
        <LightTooltip className="infoarea" title="This Post was not appropriate for displaying to candidates." placement="top-end">
...
export default ApplicationSavedBoxListSuspend;
