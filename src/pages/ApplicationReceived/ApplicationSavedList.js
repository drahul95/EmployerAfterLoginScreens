...
import ApplicationMultipleSelectionAction from "./ApplicationMultipleSelectionAction";
import ApplicationExcelDivArea from "./ApplicationExcelDivArea";
require("dotenv").config();
const BASE_URL = process.env.REACT_APP_BASE_URL;

function ApplicationSavedList() {
  ...
  return (
    <Box component="div" className="sugcandidiv">
      <ApplicationExcelDivArea />
      <ApplicationMultipleSelectionAction />
