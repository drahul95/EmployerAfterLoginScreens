...
function ApplicationBoxDropdown() {
  return (
    <Box component="div" className="autocompdiv dis_flex mt-4">
      ...
      <Autocomplete
        ...
        renderInput={(params) => {
          params.inputProps.className = "noborderinput";
          params.InputProps.className = "noBeforeAfter";
          params.InputProps.placeholder = "Job Posting Status";
          return (
            <TextField
              disabled
              inputStyle={{ cursor: "none" }}
...
export default ApplicationBoxDropdown;
const ExcelIcon = () => {
  return (
    <svg
...
const posting = [
  { name: "Activate", id: 1 },
  { name: "De-Activate", id: 2 },
  { name: "Extend Job Posting", id: 3 },
];
