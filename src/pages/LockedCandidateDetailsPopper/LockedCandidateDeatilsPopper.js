...
import "./LockedCandidateDetailsPopper.scss";
import CloseIcon from "@material-ui/icons/Close";
import { withStyles, makeStyles } from '@material-ui/core/styles';
import UsingCreditsModalUnlock from "../UsingCreditsModal/UsingCreditsModalUnlock";
...
function CandidateDeatilsPopper() {
  ...
  const [openmodalUnlockedSuccess, setOpenModalUnlockedSuccess] = React.useState(false);
  ...
  const infolongtext = `
  By Unlocking you shall be able to view the Full Name, Image, Contact Details and Resume of the Candidate. 
  Also you may start a Chat with the candidate on the JIE portal itself.
`;
        ...
        <Box component="div" className="detailsdiv">
          ...
          <Box component="div" className="detailsrow">
            <img
              ...
              alt=""
              className="profileimg blurimage"
            />
            <Box component="div" className="Namediv">
              ...
              <Box component="div" className="otherdet">
                <Button
                  ...
                  className="unlockbtn border8"
                  onClick={handleunlockmodalOpen}
                >
                  Unlock
                </Button>
                <LightTooltip title={infolongtext} placement="bottom">
                  <Button
                    startIcon={<InfoIcon />}
                    className="infodiv2 me-3 ms-1 transparentbtn"
                  ></Button>
                </LightTooltip>
          ...
          <Box component="div" className="otherdetailstab">
            ...
            <TabPanel value={valuePopper} index={0} className="workexptab">
              ...
              {/* No Data Div Area */}
              {/* <Box component="div" className="nodatadiv mt-4 mb-4 block text-center">
                <NotProvidedWorkExp />
                <Typography variant="span" className="font16 block">
            ...
            <TabPanel value={valuePopper} index={1} className="eduexptab">
              {/* No Data Div Area */}
              {/* <Box component="div" className="fresherdiv block mt-4 mb-4 text-center">
                <NotProvidedPersonal />
                <Typography variant="span" className="font16 block">
                  Yet to be provided by the candidate
                </Typography>
...
const NotProvidedWorkExp = () => {
  return(
<svg xmlns="http://www.w3.org/2000/svg" width="103.864" height="93.809" viewBox="0 0 103.864 93.809">
...
const FresherIcon = () =>{
  return(
    <svg xmlns="http://www.w3.org/2000/svg" width="199" height="178" viewBox="0 0 199 178">
  <defs>
