...
import SavedBG from "../../images/savedBg.svg";
...
import CandidateSavedEmpty from "./CandidateSavedEmpty";
import CandidateSavedBoxList from "./CandidateSavedBoxList";
import CandidateSavedList from "./CandidateSavedList";
  ...
  return (
    <div className={classes.root}>
      ...
      <main className="bodygey">
        <div className={classes.toolbar} />
        <Box className="pagecontentarea candidatesavedcontent">
...
export default CandidateSavedDemo;
const search = [
  { name: "Prashant", id: 1 },
  { name: "Vivek", id: 2 },
  { name: "Soumali", id: 3 },
